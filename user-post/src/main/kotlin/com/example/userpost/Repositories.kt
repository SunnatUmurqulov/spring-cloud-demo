...
interface PostRepository : BaseRepository<Post> {
    fun findPostByIdAndDeletedFalseAndUserId(id: Long, userId: Long): Post?
    fun existsByIdAndDeletedFalse(id: Long): Boolean
}

interface CommentsRepository : BaseRepository<Comments> {
    fun findByIdAndPostIdAndUserIdAndDeletedFalse(id: Long, postId: Long, userId: Long): Comments?
}

interface LikedUserRepository : BaseRepository<Likes> {
    fun existsByPostIdAndUserIdAndDeletedFalse(postId: Long,userId: Long):Boolean
}
